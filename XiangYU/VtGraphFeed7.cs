...
public class VtGraphFeed7 : MonoBehaviour
{
    float lastTime = 0f;
    ...
    void MyAddPoint()
    {
        ...
        if (lastTime + 0.01f <= curTime)
        {
            ...
            {
                graph.DataSource.AddPointToCategory3("Player 1", MyTimer7.m_Timer, 3.0); // each time we call AddPointToCategory
                graph.DataSource.AddPointToCategory3("Player 2", MyTimer7.m_Timer, 6.0);
